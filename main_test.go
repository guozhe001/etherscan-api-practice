...
func Test_writeSourceCodeStr(t *testing.T) {
	type args struct {
		name    string
		address string
		s       string
	...
	tests := []struct {
		...
		{
			name:    "bnb",
			args:    args{name: "BNB", address: "0xb8c77482e45f1f44de1745f52c74426c631bdd52", s: bnbContractSourceCode},
			wantErr: false,
		},
	}
